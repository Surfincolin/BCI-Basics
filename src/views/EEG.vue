<template>
  <div class="eeg article">
    <h1>EEG - Electroencephalogram</h1>
		...
		<p>With a metal electrode place on the scalp we can actually measure these small voltages. We need some fancy amplifiers, but those are often built into the device measuring the voltages. From there we can take those values and study them or uses them in a BCI application.</p>
